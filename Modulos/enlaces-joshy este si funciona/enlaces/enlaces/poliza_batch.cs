...
namespace enlaces
{
    public partial class poliza_batch : Form
    {
        ...
        public poliza_batch()
        {
            ...
            tablas = "partida";
            condicion = " WHERE estado='batch' ORDER BY idPartida";
        ...
        //funcion ya agregada al nuevo modulo
        ...
        private void poliza_batch_Load(object sender, EventArgs e)
        {
        ...
        private void Dgv_insertar_partida_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
